...
class GsonUtilTest {
    ...
    fun testFromJson() {
        val musicResponseListJson =
            "{\"code\":1,\"msg\":\"msg\",\"data\":[{\"album_title\":\"test\",\"author\":\"test\",\"info\":\"test\",\"language\":\"test\",\"pic_big\":\"test\",\"pic_huge\":\"test\",\"pic_premium\":\"test\",\"pic_singer\":\"test\",\"pic_small\":\"test\",\"publishtime\":\"test\",\"si_proxycompany\":\"test\",\"song_id\":\"test\",\"ting_uid\":\"test\",\"title\":\"test\"}]}"
