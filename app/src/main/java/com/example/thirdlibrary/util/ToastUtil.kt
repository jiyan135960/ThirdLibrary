...
object ToastUtil {
    ...
    private var textSize = 18 // in SP

    private var tintIcon = true


    private lateinit var context: Application
    internal fun init(app: Application, config: ToastUtil.Config = ToastUtil.Config.get()) {
        context = app
        config.apply()
    }
    ...
    private val toastMap by lazy(LazyThreadSafetyMode.SYNCHRONIZED) {
        mapOf(
            style.NORMAL to ToastUtil.normal("", Toast.LENGTH_LONG),
            style.SUCCESS to ToastUtil.success("", Toast.LENGTH_LONG),
            style.ERROR to ToastUtil.error("", Toast.LENGTH_LONG),
            style.INFO to ToastUtil.info("", Toast.LENGTH_LONG),
            style.WARN to ToastUtil.warning("", Toast.LENGTH_LONG)
        )
    }
    ...
    fun toast(msg: String, style: style = ToastUtil.style.NORMAL) {
        if (mainLooper == Looper.myLooper()) {
            ...
            Looper.prepare()
            ToastUtil.normal(msg, Toast.LENGTH_SHORT).show()
            Looper.loop()
        }
    }
    ...
    @JvmStatic
    @JvmOverloads
    fun toast(@StringRes strId: Int, style: style = ToastUtil.style.NORMAL) = toast(context.getString(strId), style)
    ...
    fun normal(
        ...
        return custom(context.getString(message), icon, NORMAL_COLOR, duration, withIcon, true)
    }
    ...
    fun normal(
        ...
        return custom(message, icon, NORMAL_COLOR, duration, withIcon, true)
    }
    ...
    fun warning(@StringRes message: Int, duration: Int, withIcon: Boolean): Toast {
        return custom(
            context.getString(message), ToastyUtils.getDrawable(R.drawable.ic_error_outline_white_48dp),
    ...
    @CheckResult
    @JvmOverloads
    fun warning(message: CharSequence, duration: Int = Toast.LENGTH_SHORT, withIcon: Boolean = true): Toast {
        return custom(
            message, ToastyUtils.getDrawable(R.drawable.ic_error_outline_white_48dp),
            WARNING_COLOR, duration, withIcon, true
        )
    }
    ...
    fun info(@StringRes message: Int, duration: Int, withIcon: Boolean): Toast {
        return custom(
            context.getString(message), ToastyUtils.getDrawable(R.drawable.ic_info_outline_white_48dp),
    ...
    @CheckResult
    @JvmOverloads
    fun info(message: CharSequence, duration: Int = Toast.LENGTH_SHORT, withIcon: Boolean = true): Toast {
        return custom(
            message, ToastyUtils.getDrawable(R.drawable.ic_info_outline_white_48dp),
            INFO_COLOR, duration, withIcon, true
        )
    }
    ...
    fun success(@StringRes message: Int, duration: Int, withIcon: Boolean): Toast {
        return custom(
            context.getString(message), ToastyUtils.getDrawable(R.drawable.ic_check_white_48dp),
    ...
    @CheckResult
    @JvmOverloads
    fun success(message: CharSequence, duration: Int = Toast.LENGTH_SHORT, withIcon: Boolean = true): Toast {
        return custom(
            message, ToastyUtils.getDrawable(R.drawable.ic_check_white_48dp),
            SUCCESS_COLOR, duration, withIcon, true
        )
    }
    ...
    fun error(@StringRes message: Int, duration: Int, withIcon: Boolean): Toast {
        return custom(
            context.getString(message), ToastyUtils.getDrawable(R.drawable.ic_clear_white_48dp),
    ...
    @CheckResult
    @JvmOverloads
    fun error(message: CharSequence, duration: Int = Toast.LENGTH_SHORT, withIcon: Boolean = true): Toast {
        return custom(
            message, ToastyUtils.getDrawable(R.drawable.ic_clear_white_48dp),
            ERROR_COLOR, duration, withIcon, true
        )
    }
    ...
    fun custom(
        ...
        return custom(context.getString(message), icon, -1, duration, withIcon, false)
    }
    ...
    fun custom(
        ...
        return custom(message, icon, -1, duration, withIcon, false)
    }
    ...
    fun custom(
        ...
        return custom(
            context.getString(message), ToastyUtils.getDrawable(iconRes),
    ...
    fun custom(
        ...
        return custom(
            context.getString(message), icon, tintColor, duration,
            withIcon, shouldTint
        )
    }
...
//        toastTextView.typeface = currentTypeface
        ...
        currentToast.setGravity(Gravity.BOTTOM, 0, -500)
        return currentToast
    }
    ...
    {
        @ColorInt
        var textColor = ToastUtil.DEFAULT_TEXT_COLOR
        @ColorInt
        var errorColor = ToastUtil.ERROR_COLOR
        @ColorInt
        var infoColor = ToastUtil.INFO_COLOR
        @ColorInt
        var successColor = ToastUtil.SUCCESS_COLOR
        @ColorInt
        var warningColor = ToastUtil.WARNING_COLOR

        var typeface = ToastUtil.currentTypeface
    ...
    private object ToastyUtils {
        ...
        internal fun tint9PatchDrawableFrame(@ColorInt tintColor: Int): Drawable {
            val toastDrawable = getDrawable(R.drawable.toast_frame)
...
fun String.normalToast() = ToastUtil.toast(this, ToastUtil.style.NORMAL)
fun String.successToast() = ToastUtil.toast(this, ToastUtil.style.SUCCESS)
fun String.errorToast() = ToastUtil.toast(this, ToastUtil.style.ERROR)
fun String.warnToast() = ToastUtil.toast(this, ToastUtil.style.WARN)
fun String.infoToast() = ToastUtil.toast(this, ToastUtil.style.INFO)